...
-- игроки
INSERT INTO players (club_id, first_name, last_name, jersey_number, position, birth_date, nationality, height_cm, weight_kg) VALUES
...
-- матчи (season_id заменен на season_year = 2026)
INSERT INTO matches (season_year, round_number, date_time, stadium, home_club_id, away_club_id, home_goals, away_goals, status) VALUES
                                                                                                                                    (2026, 1, '2026-03-05 18:00:00', 'Stadium 1', 1, 2, 2, 1, 'FINISHED'),
                                                                                                                                    (2026, 1, '2026-03-06 18:00:00', 'Stadium 3', 3, 4, NULL, NULL, 'SCHEDULED');
